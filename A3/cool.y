...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    | CLASS TYPEID INHERITS error '{' features '}' ';'
    ...
    | error '(' formals ')' ':' TYPEID '{' expression '}' ';'
    ...
    /* Expressions, two kinds, separated by ',' or ';'*/
    ...
    { $$ = let($2,$4,no_expr(),$6); }
    | LET OBJECTID ':' TYPEID ASSIGN expression ',' let_stmt
    { $$ = let($2,$4,$6,$8); }
    | LET OBJECTID ':' TYPEID ASSIGN error ',' let_stmt
    ;

    /* Let Statement */
    let_stmt: OBJECTID ':' TYPEID IN expression
    { $$ = let($1,$3,no_expr(),$5); }
    | OBJECTID ':' TYPEID ASSIGN expression IN expression
    { $$ = let($1,$3,$5,$7); }
    | OBJECTID ':' TYPEID ',' let_stmt
    { $$ = let($1,$3,no_expr(),$5); }
    | OBJECTID ':' TYPEID ASSIGN expression ',' let_stmt
    { $$ = let($1,$3,$5,$7); }
    | OBJECTID ':' TYPEID IN error
    | OBJECTID ':' TYPEID ASSIGN error IN expression
    | OBJECTID ':' TYPEID ASSIGN expression IN error
    | OBJECTID ':' TYPEID ASSIGN error ',' let_stmt
    ;
